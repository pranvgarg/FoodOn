...
public class ChefPreparedOrder extends AppCompatActivity {
    ...
    private void ChefPrepareOrders() {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("ChefFinalOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
