...
import com.foodon.app.SendNotification.APIService;
import com.foodon.app.SendNotification.Client;
import com.foodon.app.SendNotification.Data;
import com.foodon.app.SendNotification.MyResponse;
import com.foodon.app.SendNotification.NotificationSender;
import com.foodon.app.SendNotification.Client;
import com.foodon.app.SendNotification.Data;
import com.foodon.app.SendNotification.MyResponse;
...
public class ChefOrdertobePrepareView extends AppCompatActivity {
    ...
    private void CheforderdishesView() {
        ...
        reference = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("ChefWaitingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("Dishes");
                ...
                if (chefWaitingOrdersList.size() == 0) {
                    ...
                    Preparing.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            DatabaseReference databaseReference1 = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("ChefWaitingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("Dishes");
                            databaseReference1.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                                        ...
                                        FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("ChefFinalOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("Dishes").child(dishid).setValue(hashMap);
                                    }
                                    DatabaseReference data = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("ChefWaitingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("OtherInformation");
                                                                ...
                                                                public void onComplete(@NonNull Task<Void> task) {
                                                                    FirebaseDatabase.getInstance().getReference("ChefWaitingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("OtherInformation").removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                        ...
                                                                        public void onSuccess(Void aVoid) {
                                                                            ...
                                                                            FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference().child("Tokens").child(userid).child("token").addListenerForSingleValueEvent(new ValueEventListener() {
                                                                                @Override
                                                                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("ChefWaitingOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUID).child("OtherInformation");
