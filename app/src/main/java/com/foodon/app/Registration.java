...
public class Registration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("Customer");
                            ...
                            if (task.isSuccessful()){
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        firebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("Customer")
