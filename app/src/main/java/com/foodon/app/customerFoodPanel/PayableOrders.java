...
import com.foodon.app.customerFoodPanel.*;
...
public class PayableOrders extends AppCompatActivity {
    ...
    private void CustomerpayableOrders() {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("CustomerPaymentOrders").child(FirebaseAuth.getInstance().getCurrentUser().getUid());
