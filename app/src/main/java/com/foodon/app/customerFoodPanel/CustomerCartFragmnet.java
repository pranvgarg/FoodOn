...
import com.foodon.app.ReusableCode.ReusableCodeForAll;
...
public class CustomerCartFragmnet extends Fragment {
    ...
    private void customercart() {
        ...
        databaseReference = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("Cart").child("CartItems").child(userID);
