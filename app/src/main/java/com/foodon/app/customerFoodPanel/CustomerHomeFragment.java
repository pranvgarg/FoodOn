...
public class CustomerHomeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                dataaa = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("Customer").child(userid);
    ...
    private void customermenu() {
        ...
        swipeRefreshLayout.setRefreshing(true);
        databaseReference = FirebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("FoodSupplyDetails");
