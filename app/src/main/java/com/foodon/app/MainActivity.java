            ...
            public void run() {
                ...
                if(Fauth.getCurrentUser()!=null){
                    if(Fauth.getCurrentUser().isEmailVerified()){
                        ...
                        databaseReference = firebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("User").child(FirebaseAuth.getInstance().getUid()+"/Role");
