...
public class ChefRegistration extends AppCompatActivity {
    ...
    String[] Punjab = {"Moga","Ludhiana","Amritsar", "Jalandhar","Patiala"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("Chef");
                ...
                if (isValid()){
                    ...
                    FAuth.createUserWithEmailAndPassword(emailid,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            System.out.println("we are inside onComplete");
                            if (task.isSuccessful()){
                                System.out.println("we are inside task.sucessful");
                                String useridd = FirebaseAuth.getInstance().getCurrentUser().getUid();
                                System.out.println("-------");
                                databaseReference = firebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/").getReference("User").child(useridd);
                                System.out.println("|||||||");
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        FirebaseDatabase datab = firebaseDatabase.getInstance("https://foodon-1393f-default-rtdb.firebaseio.com/");
                                        datab.getReference("Chef")
